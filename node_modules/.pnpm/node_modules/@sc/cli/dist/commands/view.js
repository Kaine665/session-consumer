import { aggregateProjects, aggregateSessions, loadSessionMessages, extractText, } from "@sc/core";
export async function viewSession(providers, sessionId, opts) {
    ...
    for (const project of projects) {
        ...
        const session = sessions.find((s) => s.id.includes(sessionId) || s.actualSessionId.includes(sessionId));
        if (!session)
            continue;
